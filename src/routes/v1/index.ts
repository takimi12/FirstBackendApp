...
router.post("/product", verifyToken, (req: AuthRequest, res) => {
...
// =====================================
router.post("/review", verifyToken, (req: AuthRequest, res) => {
...
// =====================================
router.get("/cart", verifyToken, getUserCart);
router.post("/cart/add", verifyToken, (req: AuthRequest, res) => {
  req.body.userId = req.user?.uid;
  return addToCart(req, res);
});
router.post("/cart/remove", verifyToken, (req: AuthRequest, res) => {
  req.body.userId = req.user?.uid;
...
router.post(
  "/excel",
  verifyToken,
  uploadSpreadsheetConfig.single("file"),
...
router.post("/order/create", verifyToken, (req: AuthRequest, res) => {
  req.body.userId = req.user?.uid;
